...
import com.android.settings.display.SystemThemeDarkBackgroundPreferenceController;
...
public class DisplaySettings extends DashboardFragment {
    ...
    private static List<AbstractPreferenceController> buildPreferenceControllers(
        ...
        controllers.add(new SystemThemeDarkBackgroundPreferenceController(context));
