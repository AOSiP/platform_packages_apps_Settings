...
import com.android.settings.fuelgauge.UpTimePreferenceController;
...
public class PowerUsageSummary extends PowerUsageBase implements OnLongClickListener,
    ...
    protected void refreshUi(@BatteryUpdateType int refreshType) {
        ...
        mBatteryTemp.setSubtitle(
                com.android.internal.util.aosip.aosipUtils.mccCheck(getContext()) ?
                com.android.internal.util.aosip.aosipUtils.batteryTemperature(getContext(), true) + "°F" :
                com.android.internal.util.aosip.aosipUtils.batteryTemperature(getContext(), false) + "°C");
    }
